...
formAgregarBibliografia.addEventListener('submit', function(evt) {
    ...
    const nombre = $('#txtNombreBibliografia').val()
            ...
            <div class="row mb-0">
                <div class="col-10 mb-0">
                    <div class="form-group mb-2">
                        ...
                        <input class="form-control" type="text" name="bibliografias[${index}].NombreBibliografia" value="${bibliografia.nombre}" readonly />
                    </div>
                </div>
                <div class="col-2">
                        <div class="form-group mb-2">
